...
If Request("name") <> "" then
	...
	if objDict(strUserID) = strPassword and strUserID = "guy" then
		Response.Write ("Success")
		Response.Redirect ("authorize.aspx?name=guy")
	
	elseif  objDict(strUserID) = strPassword and strUserID = "guest" then
		Response.Write ("Success")
		Response.Redirect ("authorize.aspx?name=guest")	
	
	elseif not objDict(strUserID) = strPassword then
